...
const EditProducts = () => {
  ...
  const { addProducts, categories, productLoading, products, deleteProduct } =
            ...
            <div className="tm-bg-primary-dark tm-block tm-block-h-auto">
              ...
              <div className="row tm-classNameName-product-row">
                <div className="col-xl-6 col-lg-6 col-md-12">
                  ...
                  />
                  <div>
                    <button className="btn" onClick={() => deleteProductHandler(product?.productId!)}>
                      Delete Product
                    </button>
                  </div>
                </div>
...
export default observer(EditProducts);
